const GlobalBackground = () => {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-bg-primary transition-colors duration-500">
      ...
      <div 
        className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full blur-[125px] animate-pulse-slow"
        style={{ background: 'radial-gradient(circle, var(--orb-1-color) 0%, transparent 70%)' }}
      ></div>
      
      <div 
        className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] rounded-full blur-[125px] animate-pulse-slow" 
        style={{ 
      ...
      <div 
        className="absolute top-[30%] left-[30%] w-[45%] h-[45%] rounded-full blur-[125px] animate-pulse-slow" 
        style={{ 
